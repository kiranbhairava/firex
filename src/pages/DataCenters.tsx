...
const DataCenters = () => {
  return (
    <div className="bg-white min-h-screen flex flex-col">
      <Header />
      {/* Hero Section */}
      <div className="relative w-full h-[320px] flex items-center justify-center" style={{ backgroundImage: 'url(https://www.kanexfire.com/images/industries-Wise-Products/Server-room.jpg)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
        <div className="absolute inset-0 bg-black bg-opacity-60"></div>
        <div className="relative z-10 text-center">
          <h1 className="text-3xl md:text-5xl font-bold text-white mb-4">Fire Extinguisher For Server Rooms</h1>
        </div>
      </div>
      {/* Breadcrumb */}
      <div className="container mx-auto px-4 py-4 text-xs text-gray-500">
        Home / Industries / Fire Extinguisher For Server Rooms
      </div>
      {/* Main Content */}
      <div className="container mx-auto px-4 py-8">
        {/* UPS ROOMS Section */}
        <div className="mb-10">
          <h2 className="text-xl font-bold text-gray-800 mb-4">UPS ROOMS</h2>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="bg-white rounded shadow p-4 flex flex-col items-center">
              ...
              <div className="font-semibold mb-2">Total Flooding System</div>
              <img src="https://www.kanexfire.com/images/industries-Wise-Products/Product-Images/Total-Flooding-System.png" alt="Total Flooding System" className="h-24 mb-2" />
              <a href="#" className="text-blue-700 text-xs font-semibold mt-2">Know More &gt;&gt;</a>
            </div>
            {/* Panel Flooding System */}
            <div className="bg-white rounded shadow p-4 flex flex-col items-center">
              <div className="font-bold text-red-600 text-sm mb-2">Panel Flooding System</div>
        ...
        {/* SERVER ROOM Section */}
        <div className="mb-10">
          <h2 className="text-xl font-bold text-gray-800 mb-4">SERVER ROOM</h2>
